...
const productionData = [
  ...
  { name: "Week 3", planned: 450, actual: 420 },
  { name: "Week 4", planned: 470, actual: 460 },
]
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">86 SKUs in stock</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            <div className="h-[400px] w-full">
              ...
              <div className="flex h-full items-center justify-center">
                <p className="text-muted-foreground">Financial data visualization</p>
              </div>
            </div>
          </CardContent>
        </Card>
